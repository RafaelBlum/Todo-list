...
<div class="bg-gray-300 px-8">


    <div class="md:flex items-center" style="border: red 1px solid;">

        {{--DIV LEFT --}}
        <div class="w-full md:w-1/2 z-1 bg-gray-100 rounded shadow-lg" style="border: blue 3px solid;">
        ...
        {{--DIV RIGTH --}}
        <div class="w-full md:w-1/2 z-0 px-8 md:px-0 md:py-16" style="border: #a0a000 3px solid;">
